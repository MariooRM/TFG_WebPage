<template>
    <div>
      <TabMenuComponent />
      <DataTable class="flex-grow text-xl mb-5" :value="statsStore.deathsRanking" size="large" style="border-radius: 7px; white-space: nowrap;">
        ...
        <Column field="deaths" header="Deaths" class="w-20rem"></Column>
      </DataTable>
    </div>
  </template>
  ...
  <script setup>
  /**
   * @module Leaderboard/Deaths
   * @description Deaths view for the leaderboard page
   */
    ...
    const items = [
      { rank: 1, deaths: 5, username: 'Player 1', profileImg: 'path/to/paco.jpg' },
      { rank: 2, deaths: 8, username: 'Player 2', profileImg: 'path/to/jugador2.jpg' },
      { rank: 3, deaths: 15, username: 'Player 3', profileImg: 'path/to/jugador3.jpg' },
      { rank: 4, deaths: 22, username: 'Player 4', profileImg: 'path/to/jugador4.jpg' },
      { rank: 5, deaths: 22, username: 'Player 5', profileImg: 'path/to/jugador5.jpg' }
    ];
  </script>
